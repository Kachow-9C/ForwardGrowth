// Contact Page: 
// Client wanted a simple contact page for users to see the team. Should have a picture and description. 
// Client also wanted links to her email and social medias
